...
namespace blade
{
    namespace window
    {
        std::optional<std::unique_ptr<window>> window::create(
            ...
            uint32_t client_width = wnd->_width;
            uint32_t client_height = wnd->_height;
        ...
        const void window::_pump_messages() {
            MSG msg;
        ...
        LRESULT CALLBACK window::WindowProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
            ...
            case WM_CLOSE:
            {
                ...
                p_wnd->_close();
                events::dispatch_event(events::window_close());
                return true;
            } break;
            ...
            case WM_SIZE: {
                ...
                events::dispatch_event<events::window_resize>(ev);
            } break;
