    ...
    namespace gfx
    {
        namespace vk
        {
            ...
            public:
                ...
                const std::optional<u32> graphics_queue_index() const noexcept
                {
                    return _info.queue_family_indices.graphics;
                }

                const std::optional<u32> transfer_queue_index() const noexcept
                {
                    return _info.queue_family_indices.transfer;
                }

                const std::optional<u32> compute_queue_index() const noexcept
                {
                    return _info.queue_family_indices.compute;
                }
            ...
            public:
                ...
                std::optional<u32> graphics_queue_index() const noexcept
                {
                    return _physical_device->graphics_queue_index();
                }

                std::optional<u32> present_queue_index(const struct surface& surface) noexcept
                {
                    return _physical_device->present_queue_index(surface);
                }
                ...
                const std::weak_ptr<const physical_device> get_physical_device() const noexcept
                {
                ...
                [[nodiscard]] std::optional<u32> get_queue_index(const queue_type type) const noexcept;

                [[nodiscard]] explicit device(std::shared_ptr<physical_device> physical_device) : _physical_device{
                    physical_device
                }
                {
                }
